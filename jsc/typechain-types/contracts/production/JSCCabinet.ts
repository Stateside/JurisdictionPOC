...
export interface JSCCabinetInterface extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "EXECUTIVE_ROLE()": FunctionFragment;
    "JUDICIAL_ROLE()": FunctionFragment;
    "LEGISLATIVE_ROLE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "EXECUTIVE_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "JUDICIAL_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "LEGISLATIVE_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface JSCCabinet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JSCCabinetInterface;
  ...
  functions: {
    ...
    EXECUTIVE_ROLE(overrides?: CallOverrides): Promise<[string]>;

    JUDICIAL_ROLE(overrides?: CallOverrides): Promise<[string]>;

    LEGISLATIVE_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    EXECUTIVE_ROLE(overrides?: CallOverrides): Promise<BigNumber>;

    JUDICIAL_ROLE(overrides?: CallOverrides): Promise<BigNumber>;

    LEGISLATIVE_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    EXECUTIVE_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    JUDICIAL_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    LEGISLATIVE_ROLE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
