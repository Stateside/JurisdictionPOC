...
import type {
  IJSCFreezable,
  IJSCFreezableInterface,
} from "../../contracts/IJSCFreezable";
...
export class IJSCFreezable__factory {
  static readonly abi = _abi;
  static createInterface(): IJSCFreezableInterface {
    return new utils.Interface(_abi) as IJSCFreezableInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IJSCFreezable {
    return new Contract(address, _abi, signerOrProvider) as IJSCFreezable;
  }
}
