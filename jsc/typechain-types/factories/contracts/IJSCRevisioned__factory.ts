...
import type {
  IJSCRevisioned,
  IJSCRevisionedInterface,
} from "../../contracts/IJSCRevisioned";
...
export class IJSCRevisioned__factory {
  static readonly abi = _abi;
  static createInterface(): IJSCRevisionedInterface {
    return new utils.Interface(_abi) as IJSCRevisionedInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IJSCRevisioned {
    return new Contract(address, _abi, signerOrProvider) as IJSCRevisioned;
  }
}
