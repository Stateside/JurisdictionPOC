...
const showJSCTitleToken: NextPage = () => {
  ...
  const lastError = useMemo(
    () => localError || (error?.cause as unknown as string),
    [localError, error]
  );
            ...
            {lastError ? (
              ...
              <TableContainer whiteSpace={'normal'}>
                <Table variant="simple">
                  <TableCaption>
                    {jscTitleTokenLabels.tableCaption}
                  </TableCaption>
                  <Thead>
                    <Tr>
                      <Th>ID</Th>
                  ...
                  <Tbody>
                    {tokens.map(t => (
                      <Tr key={t.tokenId}>
                        ...
                        <Td>
                          <Checkbox isChecked={t.frozen} readOnly={true} />
                        </Td>
                        <Td>
                          <Checkbox isChecked={t.ownerFrozen} readOnly={true} />
                        </Td>
                        <Td>
                          <List>
                            {t.offersToBuy.map((o, i) => (
                              <ListItem key={i}>
                                <>
                                  Offer to buy from {o.buyer} for {o.amount}
                                </>
                              </ListItem>
                            ))}
