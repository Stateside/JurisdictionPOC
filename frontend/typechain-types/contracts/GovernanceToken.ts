...
export interface GovernanceTokenInterface extends utils.Interface {
  functions: {
    ...
    "shareholderCount()": FunctionFragment;
    "shareholders(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "shareholderCount",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GovernanceToken extends BaseContract {
  ...
  functions: {
    ...
    shareholderCount(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  shareholders(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
  ...
  populateTransaction: {
    ...
    shareholderCount(overrides?: CallOverrides): Promise<PopulatedTransaction>;
